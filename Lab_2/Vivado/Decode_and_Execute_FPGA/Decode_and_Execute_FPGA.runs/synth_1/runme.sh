...
HD_PWD='C:/Users/wilso/OneDrive/Lab_2/Vivado/Decode_and_Execute_FPGA/Decode_and_Execute_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_7segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_7segment.tcl

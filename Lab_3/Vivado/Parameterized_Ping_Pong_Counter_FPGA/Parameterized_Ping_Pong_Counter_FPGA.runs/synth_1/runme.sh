...
HD_PWD='C:/Users/wilso/OneDrive/Lab_3/Vivado/Parameterized_Ping_Pong_Counter_FPGA/Parameterized_Ping_Pong_Counter_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_7segemnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_7segemnt.tcl
